    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-green-50 to-blue-50 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-eco-green-dark">ECO ENERGIA</h1>
        ...
        <Card className="border-green-100 shadow-lg">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-sm text-eco-green-dark hover:underline">
                    Esqueceu a senha?
                  </a>
                </div>
                <div className="relative">
              ...
              <Button type="submit" className="w-full bg-eco-green-dark hover:bg-eco-green-mid">
                Entrar
              </Button>
            </form>
          </CardContent>
          <CardFooter className="flex flex-col space-y-4">
            ...
            <div className="text-center text-sm">
              ...
              <a href="#" className="text-eco-green-dark hover:underline font-medium">
                Cadastre-se
              </a>
            </div>
          </CardFooter>
